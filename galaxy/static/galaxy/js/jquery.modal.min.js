    ...
    e.fn.modal = function (t) {
        function o() {
            ...
            i.css({
                ...
                left: e(window).width() / 2 - i.outerWidth() / 2 + e(window).scrollLeft()
            });
            if (s === false) {
                n.css({opacity: t.opacity, backgroundColor: "#" + t.background});
        ...
        function u() {
            r.stop(true).animate({
                ...
                left: e(window).width() / 2 - r.outerWidth() / 2 + e(window).scrollLeft()
            }, t.moveModalSpeed)
        }
